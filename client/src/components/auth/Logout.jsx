...
const Logout = () => {
  ...
  return (
    <div
      ...
      }] justify-between items-center px-[15px] py-[8px] gap-[5px] rounded-[25px] cursor-pointer select-none`}
    >
      <svg
        width="18"
        height="18"
        viewBox="0 0 24 24"
        fill="none"
        stroke={`${colorScheme && colorScheme[300]}`}
        strokeWidth="2"
      ...
      <p
        className={`text-[12px] font-bold text-[${
          colorScheme && colorScheme[300]
        }]`}
      >
        Logout
